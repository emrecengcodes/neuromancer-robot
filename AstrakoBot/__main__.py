...
ASTRAKOBOT_IMG = "https://i.imgur.com/fPMlUxQ.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
Neuromanc3r is hosted on heroku(Selffuck) and doesn't require any donations as of now but \
You can donate seo compatible article or jav nudes 
You can donate here ; [emrecengg](https://t.me/quiong)"""
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                text="Add Neuromanc3r to your group",
                        ...
                        [
                            InlineKeyboardButton(
                                text="Support Group",
                                url=f"https://t.me/yazilimprogramlama",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text="Source code",
                                url="https://i.imgur.com/0OpKBMw.mp4",
                            )
                        ],
                    ]
                ),
